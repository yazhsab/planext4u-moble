...
final class Planext4uLocalizations {
  ...
  String get socioTitle => _values['socio_title']!;
  String get accountTitle => _values['account_title']!;
  String get cartTitle => _values['cart_title']!;
  ...
  String get signIn => _values['sign_in']!;
  String get signOut => _values['sign_out']!;
  String get workspace => _values['workspace']!;
  String roleLabel(String role) => _values['role_$role'] ?? role;
  String destinationLabel(String destination) =>
      _values['destination_$destination'] ?? destination;
  String homeSectionTitle(String titleKey, {required String fallback}) =>
      switch (titleKey) {
        'home.hero' => _values['home_hero']!,
        'home.trust_benefits' => _values['home_trust_benefits']!,
        'home.categories' => categories,
        'home.featured' => featured,
        'home.recommendations' => _values['home_recommendations']!,
        'home.services' => _values['home_services']!,
        'home.leaderboard' => _values['home_leaderboard']!,
        'home.help' => _values['home_help']!,
        _ => fallback,
      };
...
const _translations = <String, Map<String, String>>{
  'en': {
    ...
    'destination_bookings': 'Bookings',
    'destination_promotions': 'Promotions',
    'destination_earnings': 'Earnings',
    'destination_duty': 'Duty',
    'destination_assignments': 'Tasks',
    'destination_emergency': 'Emergency',
    'destination_profile': 'Profile',
    'destination_orders': 'Orders',
    'home_hero': 'Smart shopping, everyday',
    'home_trust_benefits': 'Why Planext4u',
    'home_recommendations': 'Recommended for you',
    'home_leaderboard': 'Top local sellers',
    'home_help': 'Quick help',
    'home_services': 'Popular services',
  },
  'ta': {
    ...
    'role_vendor': 'விற்பனையாளர்',
    'role_rider': 'டெலிவரி கூட்டாளர்',
    'destination_overview': 'மேலோட்டம்',
    'destination_catalog': 'பட்டியல்',
    'destination_bookings': 'முன்பதிவுகள்',
    'destination_promotions': 'சலுகைகள்',
    'destination_earnings': 'வருமானம்',
    'destination_duty': 'பணி',
    'destination_assignments': 'பணிகள்',
    'destination_emergency': 'அவசரம்',
    'destination_profile': 'சுயவிவரம்',
    'destination_orders': 'ஆர்டர்கள்',
    'home_hero': 'புத்திசாலியான ஷாப்பிங், தினமும்',
    'home_trust_benefits': 'ஏன் Planext4u',
    'home_recommendations': 'உங்களுக்கான பரிந்துரைகள்',
    'home_leaderboard': 'சிறந்த உள்ளூர் விற்பனையாளர்கள்',
    'home_help': 'விரைவு உதவி',
    'home_services': 'பிரபலமான சேவைகள்',
  },
  'hi': {
    ...
    'role_rider': 'डिलीवरी सहयोगी',
    'destination_overview': 'अवलोकन',
    'destination_catalog': 'कैटलॉग',
    'destination_bookings': 'बुकिंग',
    'destination_promotions': 'प्रचार',
    'destination_earnings': 'कमाई',
    'destination_duty': 'ड्यूटी',
    'destination_assignments': 'कार्य',
    'destination_emergency': 'आपातकाल',
    'destination_profile': 'प्रोफ़ाइल',
    'destination_orders': 'ऑर्डर',
    'home_hero': 'स्मार्ट खरीदारी, हर दिन',
    'home_trust_benefits': 'Planext4u क्यों',
    'home_recommendations': 'आपके लिए सुझाव',
    'home_leaderboard': 'शीर्ष स्थानीय विक्रेता',
    'home_help': 'त्वरित सहायता',
    'home_services': 'लोकप्रिय सेवाएँ',
  },
  'te': {
    ...
    'role_vendor': 'విక్రేత',
    'role_rider': 'డెలివరీ భాగస్వామి',
    'destination_overview': 'అవలోకనం',
    'destination_catalog': 'కేటలాగ్',
    'destination_bookings': 'బుకింగ్‌లు',
    'destination_promotions': 'ప్రమోషన్‌లు',
    'destination_earnings': 'ఆదాయం',
    'destination_duty': 'డ్యూటీ',
    'destination_assignments': 'పనులు',
    'destination_emergency': 'అత్యవసరం',
    'destination_profile': 'ప్రొఫైల్',
    'destination_orders': 'ఆర్డర్లు',
    'home_hero': 'స్మార్ట్ షాపింగ్, ప్రతిరోజూ',
    'home_trust_benefits': 'Planext4u ఎందుకు',
    'home_recommendations': 'మీ కోసం సిఫార్సులు',
    'home_leaderboard': 'అగ్ర స్థానిక విక్రేతలు',
    'home_help': 'త్వరిత సహాయం',
    'home_services': 'ప్రసిద్ధ సేవలు',
  },
  'kn': {
    ...
    'role_rider': 'ವಿತರಣಾ ಪಾಲುದಾರ',
    'destination_overview': 'ಅವಲೋಕನ',
    'destination_catalog': 'ಕ್ಯಾಟಲಾಗ್',
    'destination_bookings': 'ಬುಕಿಂಗ್‌ಗಳು',
    'destination_promotions': 'ಪ್ರಚಾರಗಳು',
    'destination_earnings': 'ಗಳಿಕೆ',
    'destination_duty': 'ಕರ್ತವ್ಯ',
    'destination_assignments': 'ಕಾರ್ಯಗಳು',
    'destination_emergency': 'ತುರ್ತು',
    'destination_profile': 'ಪ್ರೊಫೈಲ್',
    'destination_orders': 'ಆರ್ಡರ್‌ಗಳು',
    'home_hero': 'ಸ್ಮಾರ್ಟ್ ಶಾಪಿಂಗ್, ಪ್ರತಿದಿನ',
    'home_trust_benefits': 'Planext4u ಏಕೆ',
    'home_recommendations': 'ನಿಮಗಾಗಿ ಶಿಫಾರಸುಗಳು',
    'home_leaderboard': 'ಅಗ್ರ ಸ್ಥಳೀಯ ಮಾರಾಟಗಾರರು',
    'home_help': 'ತ್ವರಿತ ಸಹಾಯ',
    'home_services': 'ಜನಪ್ರಿಯ ಸೇವೆಗಳು',
  },
  'ml': {
    ...
    'sign_out': 'സൈൻ ഔട്ട്',
    'workspace': 'പ്രവർത്തന സ്ഥലം',
    'role_customer': 'ഉപഭോക്താവ്',
    'role_vendor': 'വിൽപ്പനക്കാരൻ',
    'role_rider': 'ഡെലിവറി പങ്കാളി',
    'destination_overview': 'അവലോകനം',
    'destination_catalog': 'കാറ്റലോഗ്',
    'destination_bookings': 'ബുക്കിംഗുകൾ',
    'destination_promotions': 'പ്രമോഷനുകൾ',
    'destination_earnings': 'വരുമാനം',
    'destination_duty': 'ഡ്യൂട്ടി',
    'destination_assignments': 'ജോലികൾ',
    'destination_emergency': 'അടിയന്തരാവസ്ഥ',
    'destination_profile': 'പ്രൊഫൈൽ',
    'destination_orders': 'ഓർഡറുകൾ',
    'home_hero': 'സ്മാർട്ട് ഷോപ്പിംഗ്, എല്ലാ ദിവസവും',
    'home_trust_benefits': 'എന്തുകൊണ്ട് Planext4u',
    'home_recommendations': 'നിങ്ങൾക്കായുള്ള ശുപാർശകൾ',
    'home_leaderboard': 'മികച്ച പ്രാദേശിക വിൽപ്പനക്കാർ',
    'home_help': 'ദ്രുത സഹായം',
    'home_services': 'ജനപ്രിയ സേവനങ്ങൾ',
  },
  'mr': {
    ...
    'role_customer': 'ग्राहक',
    'role_vendor': 'विक्रेता',
    'role_rider': 'वितरण भागीदार',
    'destination_overview': 'आढावा',
    'destination_catalog': 'कॅटलॉग',
    'destination_bookings': 'बुकिंग',
    'destination_promotions': 'प्रचार',
    'destination_earnings': 'कमाई',
    'destination_duty': 'ड्युटी',
    'destination_assignments': 'कामे',
    'destination_emergency': 'आपत्कालीन',
    'destination_profile': 'प्रोफाइल',
    'destination_orders': 'ऑर्डर',
    'home_hero': 'स्मार्ट खरेदी, दररोज',
    'home_trust_benefits': 'Planext4u का',
    'home_recommendations': 'तुमच्यासाठी शिफारसी',
    'home_leaderboard': 'आघाडीचे स्थानिक विक्रेते',
    'home_help': 'त्वरित मदत',
    'home_services': 'लोकप्रिय सेवा',
  },
  'bn': {
    ...
    'role_vendor': 'বিক্রেতা',
    'role_rider': 'ডেলিভারি সহযোগী',
    'destination_overview': 'সারসংক্ষেপ',
    'destination_catalog': 'ক্যাটালগ',
    'destination_bookings': 'বুকিং',
    'destination_promotions': 'প্রচার',
    'destination_earnings': 'আয়',
    'destination_duty': 'ডিউটি',
    'destination_assignments': 'কাজ',
    'destination_emergency': 'জরুরি',
    'destination_profile': 'প্রোফাইল',
    'destination_orders': 'অর্ডার',
    'home_hero': 'স্মার্ট কেনাকাটা, প্রতিদিন',
    'home_trust_benefits': 'কেন Planext4u',
    'home_recommendations': 'আপনার জন্য প্রস্তাবিত',
    'home_leaderboard': 'শীর্ষ স্থানীয় বিক্রেতা',
    'home_help': 'দ্রুত সহায়তা',
    'home_services': 'জনপ্রিয় পরিষেবা',
  },
  'gu': {
    ...
    'role_vendor': 'વિક્રેતા',
    'role_rider': 'ડિલિવરી ભાગીદાર',
    'destination_overview': 'ઝાંખી',
    'destination_catalog': 'કેટલોગ',
    'destination_bookings': 'બુકિંગ',
    'destination_promotions': 'પ્રમોશન',
    'destination_earnings': 'કમાણી',
    'destination_duty': 'ડ્યુટી',
    'destination_assignments': 'કાર્યો',
    'destination_emergency': 'કટોકટી',
    'destination_profile': 'પ્રોફાઇલ',
    'destination_orders': 'ઓર્ડર',
    'home_hero': 'સ્માર્ટ ખરીદી, દરરોજ',
    'home_trust_benefits': 'Planext4u શા માટે',
    'home_recommendations': 'તમારા માટે ભલામણો',
    'home_leaderboard': 'ટોચના સ્થાનિક વેચાણકર્તાઓ',
    'home_help': 'ઝડપી મદદ',
    'home_services': 'લોકપ્રિય સેવાઓ',
  },
};
