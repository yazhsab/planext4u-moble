...
The entry slice is pinned to backend commit `5bb8125`. Mobile CI validates exact catalog and commerce OpenAPI snapshots plus the authoritative cart fixture before analysis and tests.
