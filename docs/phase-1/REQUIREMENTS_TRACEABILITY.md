...
`Status` is `Specified`, `POC observed`, `POC partial`, `Audit pending`, `Decision pending` or `Approved`. POC states describe visible black-box evidence only; they do not approve the target requirement or prove backend behaviour. No row may be deleted; superseded requirements remain linked to their decision record.
...
| P4U-ID-002 | Email/password login and password setup/reset | All | FRD, POC | Secure password policy, expiring reset, session/device audit and generic enumeration-safe errors | POC observed |
| P4U-ID-003 | Google OAuth | Customer | FRD, UI | System-browser OAuth, PKCE/deep link, role-safe account linking | Specified |
| P4U-ID-004 | Multi-role identity and portal routing | Customer, Vendor, Rider, Admin | FRD, TECH | One auth identity, dedicated roles, least-privilege routing and server authorisation | POC partial |
...
| P4U-CS-004 | CMS-driven personalised home | Customer | FRD, UBRD, UI | Ordered widgets, banners/deep links, categories, rails, wallet, ads, leaderboards and cache fallback | POC partial |
...
| P4U-MKT-002 | Catalog and PDP | Customer | PRD, FRD, UI, UBRD | Media zoom, variants, server stock/price, delivery estimate, trust, descriptions, reviews, Q&A and related items | POC observed |
...
| P4U-MKT-005 | Checkout and scheduled delivery | Customer | PRD, FRD, UI, UBRD | Address, schedule, coupon, wallet, itemised total, terms, idempotent place-order and failure retry | POC partial |
...
| P4U-ORD-001 | Product order lifecycle | Customer, Vendor, Rider | FRD, UI, UBRD | Placed through delivered/cancelled/returned with allowed transitions, timestamps and next actions | POC partial |
...
| ID | Requirement | Actor | Source | Acceptance baseline | Status |
| --- | --- | --- | --- | --- | --- |
| P4U-SVC-001 | Service discovery and provider trust | Customer | FRD, UI, UBRD | Geo filters, verified vendor, category, rating, completed count, live engagement and next slot | POC observed |
...
| P4U-FOOD-001 | Restaurant discovery and menu | Customer | FRD, UI | Geo discovery, availability/cut-off, categories, customisation, dietary labels and cart pricing | POC partial |
| P4U-FOOD-002 | Food order and restaurant queue | Customer, Restaurant | FRD, UI | Coupon/payment, accept/reject, preparation/ready stages, auto-cancel/refund and customer updates | POC partial |
...
| P4U-SOC-001 | Profiles, follows and privacy | Creator, Viewer | FRD, UI, UBRD | Public/private, follow/unfollow, counts, grid/reels/tagged, block/mute and access enforcement | POC partial |
| P4U-SOC-002 | Feed, posts and commerce tags | Creator, Viewer, Vendor | PRD, FRD, UBRD | Cursor feed, images/video/polls, up to 5 media, tags/stickers, visibility and ad injection | POC partial |
| P4U-SOC-003 | Engagement and moderation | Viewer, Moderator | FRD, UBRD | Like, nested comments <= 3, share/save/collections, report categories, thresholds, decision/appeal | POC partial |
| P4U-SOC-004 | Stories, highlights and reels | Creator, Viewer | FRD, UI, UBRD | 24 h expiry, progress/navigation, seen state, video limits, highlights and vertical-snap reels | POC partial |
| P4U-SOC-005 | DMs, voice notes and 1:1 calls | User, Vendor | FRD, UI | Mutual-follow policy, requests, text/media/location, 60 s voice, presence, WebRTC signalling and blocks | POC partial |
...
| ID | Requirement | Actor | Source | Acceptance baseline | Status |
| --- | --- | --- | --- | --- | --- |
| P4U-VND-001 | Vendor registration, OCR and staged KYC | Vendor, Field Officer, Admin | FRD, UBRD | Phone/email, business data, private docs, OCR review, staged notifications and decision reasons | POC partial |
...
| P4U-RDR-001 | Rider onboarding, KYC and online duty | Rider | FRD, UI | Secure login, docs/bank, online state, clock in/out, consent and background-location policy | POC partial |
...
| P4U-ADM-001 | Admin RBAC, MFA and country context | Admin roles | FRD, UI, UBRD | Least privilege, country/currency/tax/gateway context, fresh auth and session/audit review | POC partial |
| P4U-ADM-002 | Master data and entity governance | Admin, Ops | FRD | CRUD/approval for categories/attributes/occupations/users/vendors/riders with dependent-delete blocks | POC observed |
| P4U-ADM-003 | Moderation, CMS and policies | Moderator, Admin | FRD, UBRD | Queues, decisions/reasons/appeals, banners/layouts/splash, policy versions and feature flags | POC observed |
| P4U-ADM-004 | Notifications, tickets and emergency operations | Support, Admin | FRD, UBRD | Segmented broadcasts, templates, receipts, ticket assignment/SLA and emergency command view | POC partial |
| P4U-RPT-001 | Ten finance/operations report families | Finance, Ops | FRD | Server pagination, date/country/vendor filters, sanitised CSV/XLSX/PDF, queued large export and audit | POC observed |
